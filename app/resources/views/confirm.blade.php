    ...
    <form action="" method="POST">
      ...
      <div class="">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
          ...
          <input type="text" class="form-con  trol-inline" id="email" name="email" required>
        </div>
        <div class="d-flex justify-content-between align-items-center mt-4">
        ...
        <div class="text-center mt-4 form-group">
          <button type="submit" form="" class="mt-3 mr-1 mr-1 btn-light btn-light-radius">修正</button>
          <button type="submit" form="" class="mt-3 mr-1 mr-1 btn-submit">確定</button>
        </div>
      </div>
    </form>
  </div>
